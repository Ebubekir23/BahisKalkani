...
5. **Koordinasyon:** keywords.json değişince Aylin'e iletmek; açık soruları
   ([halil-tespit-modeli.md](halil-tespit-modeli.md) sonundaki) Halil'le bu
   hafta kapatmak.
...
- Cihazda: Ayarlar → Erişilebilirlik → BahisKalkanı'nı etkinleştir;
  doğrulama: `adb logcat -s BahisKalkani`
