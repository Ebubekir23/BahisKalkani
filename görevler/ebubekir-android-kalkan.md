...
1. **Model entegrasyonu (24 Temmuz sonrası):** Halil'in TFLite modeli gelince
   ...
   liste eşleşirse engelle. Kabul test setiyle doğrula. Ayrıntı:
   [MODEL_ENTEGRASYON.md](../MODEL_ENTEGRASYON.md)
2. **Sandbox uçtan uca testi:** Ezgi'nin ilk kaydırılabilir sürümü çıkar çıkmaz
   ...
   (final demosu orada). Ayrıntı: [SANDBOX_GEREKSINIMLER.md](../SANDBOX_GEREKSINIMLER.md)
...
- Derleme/test komutları ve mimari kurallar: [ProjeAkışı.md](../ProjeAkışı.md)
