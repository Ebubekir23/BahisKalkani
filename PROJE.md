...
- **Chrome Eklentisi (Aylin AKAGÜNDÜZ):** Aynı mantığın tarayıcı versiyonu, Manifest V3, content script + sayaç popup'ı. Ayrı repoda geliştiriliyor. Kelime listesi ve Detector mantığı Android tarafıyla eşdeğer tutulmalı — bir tarafta liste güncellenirse diğerine de taşınır.
