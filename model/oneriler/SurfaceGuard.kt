...
/**
 * Cheap, deterministic gate that keeps obvious UI/system/meta text away from
 * the model. It is conservative by design: if a betting-risk anchor is present,
 * the text still goes to the keyword/model decision path.
 */
class SurfaceGuard {
    ...
    private companion object {
        ...
        private const val GENERAL_THRESHOLD = 0.60f
        private const val MESSAGING_THRESHOLD = 0.70f
        private const val PROFESSIONAL_THRESHOLD = 0.76f
        private const val FOOD_THRESHOLD = 0.78f
